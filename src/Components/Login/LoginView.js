        ...
        <div className="container mb-5">
          <div className="card mx-auto mt-5 pb-3 shadow rounded" style={{width:"25rem"}}>
            <div className="card-body">
              ...
              {/* <!-- Login Form Start --> */}
              <form className="needs-validation" onSubmit={props.handleSubmit} autoComplete="off"  action="#" noValidate>
                <div className="form-group">
                  <label htmlFor="userEmail">Email: </label>
                  <input type="email" onChange={props.handleChange} value={props.email} name="email" className="form-control" placeholder="abc@abc.com" id="userEmail"
                ...
                <div className="form-group">
                  ...
                  <input type="password" onChange={props.handleChange} value={props.password} className="form-control" placeholder="******" name="password" id="userPassword"
